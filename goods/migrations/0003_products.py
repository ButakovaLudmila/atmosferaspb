# Generated by Django 5.0.5 on 2024-05-07 21:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.categories', verbose_name='Направление')),
                ('format', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.formats', verbose_name='Формат')),
            ],
            options={
                'verbose_name': 'Товар',
